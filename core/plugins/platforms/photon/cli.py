...
# Writable sidecar runtime dir (mirrors to ATHENA_HOME on immutable
...
# wiring imports this module for `athena --help`).
...
# when called later (gateway start, athena status). Cleared on success.
...
def _cmd_setup(args: argparse.Namespace) -> int:
    ...
    # 3. Provision Spectrum credentials (runtime -> ~/.athena/.env,
