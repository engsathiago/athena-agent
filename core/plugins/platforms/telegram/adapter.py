...
# trigger its own recovery path. Refs: legacy upstream issue #59614
...
# _UPDATER_STOP_TIMEOUT. Refs: legacy upstream issue #66377
_DRAIN_TIMEOUT = 15.0
...
class TelegramAdapter(BasePlatformAdapter):
        ...
        try:
            if app and app.updater and app.updater.running:
                try:
                    ...
                    # Refs: legacy upstream issue #58270
    ...
    async def _run_post_connect_housekeeping(self) -> None:
        ...
        try:
            ...
            try:
                ...
                from athena_cli.commands import telegram_menu_commands, telegram_menu_max_commands
                if not self._bot:
                    return
                # Telegram allows up to 100 commands but has an undocumented
                # payload size limit (~4KB total).  Athena defaults to 60 to
    ...
    async def connect(self, *, is_reconnect: bool = False) -> bool:
        ...
        try:
            ...
            _max_connect = 8
            _init_timeout = _env_float("ATHENA_TELEGRAM_INIT_TIMEOUT", 30.0)
                ...
                try:
                    ...
                    if asyncio.get_running_loop().time() >= _total_deadline:
                        raise OSError(
                            ...
                            f"or set ATHENA_TELEGRAM_HTTP_CONNECT_TIMEOUT / "
    ...
    def _is_own_message(self, message: Message) -> bool:
        ...
        counted as incoming unread messages in the Athena inbox.
        """
        if not self._bot:
            return False
    ...
    def _should_process_message(self, message: Message, *, is_command: bool = False) -> bool:
        ...
        # unread in the Athena inbox (#52363).
        #
...
def register(ctx) -> None:
    ...
    ctx.register_platform(
        ...
        install_hint="Run `athena setup` to install Telegram support.",
