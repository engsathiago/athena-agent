...
# When the user hasn't picked a reasoning effort, Athena passes
...
# ON at this effort — matching the "medium (default)" that Athena' /reasoning
...
class UpstageProfile(ProviderProfile):
    ...
    def build_api_kwargs_extras(
        ...
        # Map Athena' effort vocabulary onto Solar's accepted set. xhigh/max/
