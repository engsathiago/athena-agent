...
3. **Description too generic or trigger buried past char 57.** The system prompt
   ...
   - Good: `Use when debugging Athena skill discovery failures.`
   - Bad: `This skill contains detailed guidance for agents working on Athena skill discovery failures.`
