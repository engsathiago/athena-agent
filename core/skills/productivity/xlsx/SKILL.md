...
For full investment-banking conventions (balance checks, sensitivity tables, named ranges), install the optional skill: `athena skills install official/finance/excel-author`.
