...
def _default_registry_path() -> Path:
    return get_athena_home() / "state" / _REGISTRY_NAME
...
class HostSupervisor:
    ...
    def __init__(
        ...
        *,
        ...
        expected_athena_home: str | None = None,
        autostart: bool = True,
    ) -> None:
        ...
        self.expected_athena_home = expected_athena_home if expected_athena_home is not None else str(get_athena_home())
    ...
    def _validate_hello(self) -> None:
        ...
        if got_home and got_home != self.expected_athena_home:
            raise RuntimeError(f"compute host ATHENA_HOME mismatch: {got_home} != {self.expected_athena_home}")
