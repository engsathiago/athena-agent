...
const TAG_FULL = 'Athena · Inteligência, memória e execução'
const TAG_MID = 'Inteligência, memória e execução'
const TAG_TINY = 'Athena'
const HIDE_BELOW = 34
  ...
  const heroColumn = wide ? (
    <Box flexDirection="column" width="100%">
      ...
      <Text color={t.color.accent}>
        ...
        <Text color={t.color.muted}> · Athena</Text>
      </Text>
