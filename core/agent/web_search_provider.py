...
def get_provider_env(name: str) -> str:
    ...
    Resolves *name* via :func:`athena_cli.config.get_env_value` (checks
    ``os.environ`` first, then ``~/.athena/.env``) so credentials set
    through Athena' config layer are visible even when they were never
