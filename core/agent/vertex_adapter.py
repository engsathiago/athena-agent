"""Vertex AI (Google Cloud) adapter for Athena Agent.

Provides authentication and configuration for Vertex AI's OpenAI-compatible
endpoint. This allows Athena to use Gemini models via Google Cloud with
...
# who installed plain `athena-agent` and only later selected a Gemini model.
try:
