...
def execute_current(
    ...
    *,
    ...
    """Run a provider attempt under the inherited Athena turn when present."""
...
class ManagedLlmStream(Iterator[Any]):
    """Drive Relay's async stream from Athena's provider worker thread."""
