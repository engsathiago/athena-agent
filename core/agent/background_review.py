...
_SKILL_REVIEW_PROMPT = (
    ...
    "  • PINNED skills (marked via 'athena curator pin'). You are an "
    ...
    "'athena curator adopt <name>' — do not try to patch it.\n"
...
_COMBINED_REVIEW_PROMPT = (
    ...
    "  • Hub-installed skills (installed via 'athena skills install').\n"
    "  • Skills in skills.external_dirs (externally owned).\n"
    "  • PINNED skills (marked via 'athena curator pin'). Pin blocks "
    ...
    "reply and recommend 'athena curator adopt <name>' instead.\n"
    "If the only skills that need updating are protected, say\n"
    "'Nothing to save.' and stop.\n\n"
