...
# Org mirrors live under ~/.athena/skills/_org/<org_id>/. Resolution is
...
def normalize_skill_lookup_name(identifier: str) -> str:
    ...
    under ``~/.athena/skills/`` (including via symlinks) or configured
    ...
    # ~/.athena/skills/<name> where <name> is a symlink to a checked-out
...
def is_external_skill_path(path) -> bool:
    ...
    ``skills.external_dirs`` are externally owned: Athena can discover and view
