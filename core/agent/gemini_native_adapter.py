        ...
        with httpx.Client(timeout=timeout) as client:
            resp = client.post(
                ...
                headers={
                    ...
                    "X-Goog-Api-Client": f"athena-agent/{_ATHENA_VERSION}",
                },
            )
...
_FREE_TIER_GUIDANCE = (
    ...
    "for Gemini Flash models). Athena typically makes 3-10 API calls per user turn, "
...
_STANDARD_KEY_GUIDANCE = (
    ...
    "GOOGLE_API_KEY in ~/.athena/.env and restart your session. "
...
class GeminiNativeClient:
    ...
    def _headers(self) -> Dict[str, str]:
        headers = {
            ...
            "User-Agent": f"athena-agent/{_ATHENA_VERSION} (gemini-native)",
            "X-Goog-Api-Client": f"athena-agent/{_ATHENA_VERSION}",
        }
