...
def _clamp_responses_call_id(call_id: str) -> str:
    ...
    component the built-in ``athena-tools`` server already overflows 64 chars,
...
# server-assigned base64 blobs that can run 400+ chars, while Athena-minted
...
def _normalize_codex_response(
    ...
    *,
    ...
    if tool_calls:
        ...
        # See legacy upstream issue #64434
