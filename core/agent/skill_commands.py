        ...
        for scan_dir in dirs_to_scan:
            for skill_md in iter_skill_index_files(scan_dir, "SKILL.md"):
                ...
                try:
                    ...
                    # with a core Athena slash command (name or alias). The
                    ...
                    if resolve_command(cmd_name) is not None:
                        logger.warning(
                            ...
                            "collides with a core Athena command; skipping "
...
def build_preloaded_skills_prompt(
    ...
    bundle-invocation gate (#59156). Without this, ``athena -s <skill>`` or
    a deployment's ``ATHENA_TUI_SKILLS`` env var could force-load a skill an
