...
def _auto_title_enabled() -> bool:
    ...
    try:
        ...
        # from agent code paths where a module-level athena_cli import risks
...
def auto_title_session(
    ...
    post-``athena update`` stale-module window, where this function's lazy
    ...
    try:
        ...
        logger.warning(
            ...
            "restart the running Athena process): %s",
            e,
        )
