"""Public, plugin-safe lifecycle API for delegated Athena subagents.
...
_ACTIVE_PARENT_AGENT: contextvars.ContextVar[Any] = contextvars.ContextVar(
    "athena_subagent_lifecycle_parent", default=None
)
    ...
    def launch(self, request: SubagentLaunchRequest) -> SubagentHandle:
        ...
        if parent is None:
            raise SubagentLifecycleError(
                "No active Athena parent session is available."
            )
