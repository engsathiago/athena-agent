...
class CodexAppServerSession:
    ...
    def _decide_exec_approval(self, params: dict) -> str:
        ...
        This is protocol-level routing only — it carries NO Athena
        approval-mode/timeout logic. The Athena-side resolution happens
    ...
    def _decide_apply_patch_approval(self, params: dict) -> str:
        ...
        Protocol-level routing only; Athena approval-mode/timeout
...
def _approval_choice_to_codex_decision(choice: str) -> str:
    ...
    NOT in tools/approval.py: the Athena approval mode/timeout resolution
    ...
    # "prompt expired"; the Athena-side messaging already distinguishes them.
    return "decline"
