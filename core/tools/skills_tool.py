...
# Cache validation (mirrors athena_cli/profiles.py::_count_skills, d5eee133e):
...
def _skills_dir() -> Path:
    ...
    set ATHENA_HOME. Keep the legacy SKILLS_DIR module attribute for tests and
    external patchers, but when it has not been patched, resolve from the live
    profile-scoped ATHENA_HOME on every call.
    """
...
def _find_all_skills(*, skip_disabled: bool = False) -> List[Dict[str, Any]]:
    ...
    # (_skills_dir() resolves the LIVE profile ATHENA_HOME; the module-level
            ...
            try:
                ...
                if is_org_mirror_path(skill_dir, active_skills_dir):
                    ...
                    header = (
                        ...
                        "them back with\n"
                        "> `athena sync propose` (or automatically, if your "
                        "org enables it).\n\n"
                    )
