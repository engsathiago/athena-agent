...
def _is_athena_provider_credential(name: str) -> bool:
    ...
    let a skill tunnel a Athena credential into the execute_code child.
    """
    try:
        ...
        return True
    # Dynamically-generated Athena-internal secrets (AUXILIARY_*_API_KEY /
    ...
    if _is_athena_internal_secret(name):
        return True
