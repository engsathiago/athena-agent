...
class UIElement:
    ...
    # (trycua/cua#1961 — Surface 6 of legacy upstream issue #47072).
...
class CaptureResult:
    ...
    # trycua/cua#1961 — Surface 7 of legacy upstream issue #47072).
...
class ActionResult:
    ...
    verify → escalate ladder (legacy upstream issue #67052). ``ok`` stays
