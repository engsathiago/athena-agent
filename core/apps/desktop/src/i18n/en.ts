...
export const en: Translations = {
  ...
  settings: {
    ...
    gateway: {
      ...
      intro:
        'Local by default. Use remote when this app should drive a Athena backend elsewhere. Per-profile overrides below.',
      ...
      sshErrNotInstalled:
        'Athena is not installed on the remote host. Install it there (curl -fsSL https://raw.githubusercontent.com/engsathiago/athena-agent/main/bootstrap.sh | sh) or set the Athena path.',
      sshErrPlatform:
