...
export const ar = defineLocale({
  ...
  settings: {
    ...
    gateway: {
      ...
      intro:
        'يشغّل Athena Desktop بوابة محلية خاصة افتراضياً. استخدم بوابة بعيدة عندما تريد أن يتحكم هذا التطبيق بخلفية Athena تعمل مسبقاً على جهاز آخر أو خلف وكيل موثوق.',
      appliesTo: 'ينطبق على',
