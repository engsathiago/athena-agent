...
export const ja = defineLocale({
  ...
  settings: {
    ...
    gateway: {
      ...
      sshErrNotInstalled:
        'リモートホストに Athena がインストールされていません。リモートでインストールする（curl -fsSL https://raw.githubusercontent.com/engsathiago/athena-agent/main/bootstrap.sh | sh）か、Athena パスを設定してください。',
      sshErrPlatform:
