...
export function closeFindBar(): void {
  ...
  void window.athenaDesktop?.stopFindInPage()
}
...
export function setFindQuery(query: string): void {
  ...
  void window.athenaDesktop?.findInPage(query, { forward: true, findNext: false })
}
...
export function findNext(): void {
  ...
  if (query) {
    void window.athenaDesktop?.findInPage(query, { forward: true, findNext: true })
  }
}
...
export function findPrevious(): void {
  ...
  if (query) {
    void window.athenaDesktop?.findInPage(query, { forward: false, findNext: true })
  }
}
