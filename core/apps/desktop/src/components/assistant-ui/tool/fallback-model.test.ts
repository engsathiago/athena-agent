  ...
  it('shows failed title when navigate returns success=false', () => {
    const view = buildToolView(
      part({
        ...
        args: { url: 'https://github.com/engsathiago/athena-agent/docs' },
    ...
    expect(view.title).toBe('Failed to open github.com/engsathiago/athena-agent/docs')
  })
  ...
  it('shows opened title on success', () => {
    const view = buildToolView(
      part({
        toolName: 'browser_navigate',
        args: { url: 'https://github.com/engsathiago/athena-agent/docs' },
        result: { success: true, url: 'https://github.com/engsathiago/athena-agent/docs', title: 'Docs' }
      }),
      ''
    )

    expect(view.status).toBe('success')
    expect(view.title).toBe('Opened github.com/engsathiago/athena-agent/docs')
  })
})
