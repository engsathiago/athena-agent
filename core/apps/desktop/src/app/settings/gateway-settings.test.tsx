...
describe('GatewaySettings', () => {
  it('labels local mode as default inheritance for a named profile', async () => {
    ...
    expect(
      screen.queryByText('Start a private Athena backend on localhost. This is the default and works offline.')
    ).toBeNull()
  })
    ...
    getConnectionConfig.mockImplementation(async profile =>
      profile === 'work'
        ? {
            ...
            sshPort: 22,
            sshKeyPath: '',
            sshRemoteAthenaPath: '/opt/athena/bin/athena',
