...
function downloadInstallScript(ref, destPath) {
  ...
  const url = `https://raw.githubusercontent.com/engsathiago/athena-agent/${ref}/scripts/${scriptName}`
...
async function fetchManifest({ scriptPath, installerKind, emit, athenaHome, activeRoot, installStamp, pinCommit }) {
