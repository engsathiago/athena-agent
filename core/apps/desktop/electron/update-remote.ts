 ...
 *
 * A public install can end up with `origin=git@github.com:engsathiago/athena-agent.git`.
...
const OFFICIAL_REPO_HTTPS_URL = 'https://github.com/engsathiago/athena-agent.git'
const OFFICIAL_REPO_CANONICAL = 'github.com/engsathiago/athena-agent'
