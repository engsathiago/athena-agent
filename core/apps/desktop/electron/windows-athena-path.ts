 ...
 *      venv\Scripts\athena.exe (the console-script shim, written at the END
 ...
 * signals (venv python interpreter, venv athena shim, bootstrap-complete
 * marker) — gating on just the athena.exe console-script shim alone is the
