...
// delta flush does — via the __ATHENA_SESSION_TILES__ hook.
//
  ...
  (() => {
    if (window.__MT__) {
      ...
      for (const { sid, rid } of window.__MT__.ids) {
        window.__ATHENA_SESSION_TILES__.publish(rid, {
          ...window.__ATHENA_SESSION_TILES__.states()[rid], busy: false, streamId: null
        })
