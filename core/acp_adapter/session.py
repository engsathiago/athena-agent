...
def _normalize_cwd_for_compare(cwd: str | None) -> str:
    ...
    from athena_constants import windows_path_to_wsl
...
class SessionManager:
    ...
    def _restore(self, session_id: str) -> Optional[SessionState]:
        ...
        # for the rest of the session (see athena_state.get_messages_as_conversation).
        try:
    ...
    def _make_agent(
        ...
        *,
        ...
        # the automatic late-refresh (see AthenaACPAgent._schedule_mcp_late_refresh).
        try:
