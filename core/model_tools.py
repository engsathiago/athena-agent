...
def _run_async(coro):
    ...
    if loop and loop.is_running():
        ...
        # async tools resolve get_athena_home() under the active profile.
    ...
    if disabled_toolsets:
        for toolset_name in disabled_toolsets:
            if validate_toolset(toolset_name):
                ...
                if toolset_name.startswith("athena-") or (get_toolset(toolset_name) or {}).get("posture"):
                    # Platform bundles (athena-*) include _ATHENA_CORE_TOOLS, and
                    ...
                    if (not quiet_mode and toolset_name.startswith("athena-")
