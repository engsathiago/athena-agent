...
def _has_agent_browser() -> bool:
    ...
    from athena_constants import agent_browser_runnable, with_athena_node_path
    ...
    # Athena-managed Node dirs (Windows installer / POSIX $ATHENA_HOME/node)
    ...
    managed_path = with_athena_node_path().get("PATH", "")
    if managed_path:
