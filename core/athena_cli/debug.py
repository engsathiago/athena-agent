...
# desktop app talks to a remote/docker/SSH backend, `athena debug share` runs
...
def run_debug_share(args):
    ...
    print("To delete now:  athena debug delete <url>")
...
def _run_debug_share_nous(args, *, log_lines: int, redact: bool) -> None:
    """Handle ``athena debug share --nous``: upload the bundle to Nous-S3.
    ...
    if redact:
        logger.info(
            "athena debug share --nous: applied force-mode redaction before upload"
        )
