...
# to the user as a hung `athena update` (#70553 follow-up). Sessions databases
...
def verify_sqlite_integrity(
    ...
    *,
    ...
    if check_header:
        ...
        # athena_cli.sqlite_safe_read). Verification targets snapshots and
        ...
        if profiles_dir.is_dir():
            try:
                ...
                if any(profiles_dir.iterdir()):
                    ...
                    print("  Run: athena profile list  (after installing athena)")
...
_QUICK_STATE_FILES = (
    ...
    # are at $ATHENA_HOME/<name> for the default/root profile; on non-root
    # profiles the real path is outside ATHENA_HOME and the entry is silently
...
def _create_quick_snapshot_locked(
    ...
    if failed_dbs:
        ...
        print(
            ...
            f"{root} and run: athena snapshot list"
        )
        logger.error(
