...
class CLICommandsMixin:
    ...
    def _handle_diff_command(self, command: str):
        ...
        Syntax:
            ...
            /diff session          — everything Athena changed (checkpoint baseline)
    ...
    def _print_session_diff(self, cwd: str, stat_only: bool):
        ...
        if result.get("empty") or (not stat and not diff):
            print("  No changes — Athena hasn't edited any files here yet.")
            return
    ...
    def _handle_export_command(self, command: str):
        ...
        """
        from athena_cli.profiles import export_profile, get_active_profile_name
        ...
        try:
            ...
            print("  Share it: the other user runs /import or `athena profile import <archive>`.")
    ...
    def _handle_journey_command(self, cmd_original: str) -> None:
        """Handle /journey — the learning timeline (see `athena journey`).
    ...
    def _handle_resume_command(self, cmd_original: str) -> None:
        ...
        # same directory as a startup `athena -c`/`--resume`. The startup resume
    ...
    def _handle_pet_command(self, cmd: str):
        ...
        from athena_cli.pets import _set_active, _set_enabled, print_pet_gallery, set_pet_scale, toggle_pet_display
    ...
    def _handle_busy_command(self, cmd: str):
        ...
        if save_config_value("display.busy_input_mode", arg):
            if arg == "queue":
                ...
                behavior = "Enter will redirect the current run while Athena is busy; /stop still cancels it."
    ...
    def _handle_wake_command(self, command: str):
        """Handle /wake [on|off|status] — the 'Hey Athena' hotword listener.
