...
def build_relay_command_manifest() -> List[Dict[str, Any]]:
    ...
    return [
        ...
        {"name": "reset", "description": "Reset your Athena session"},
        {
            "name": "model",
        ...
        {"name": "status", "description": "Show Athena session status"},
        {"name": "sethome", "description": "Set this chat as the home channel"},
        {"name": "stop", "description": "Stop the running Athena agent"},
        {
            "name": "steer",
        ...
        {"name": "update", "description": "Update Athena Agent to the latest version"},
        {"name": "restart", "description": "Gracefully restart the Athena gateway"},
        {
            "name": "approve",
        ...
        {
            "name": "thread",
            "description": "Create a new thread and start a Athena session in it",
