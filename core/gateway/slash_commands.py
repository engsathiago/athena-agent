...
from athena_cli.config import atomic_config_write, cfg_get, clear_model_endpoint_credentials
from utils import (
    atomic_json_write,
...
class GatewaySlashCommandsMixin:
    ...
    async def _handle_model_command(self, event: MessageEvent) -> Optional[str]:
        ...
        custom_provs = None
        excluded_provs = []
        config_path = (_command_profile_home or _athena_home) / "config.yaml"
        try:
            ...
            if has_picker:
                ...
                if providers:
                    ...
                    async def _on_model_selected_scoped(
                        ...
                        from athena_cli.model_switch import resolve_display_context_length_async
                        _sw_config_ctx = None
                        _sw_model_cfg = {}
                        try:
    ...
    async def _handle_diff_command(self, event: MessageEvent) -> str:
        ...
        Athena itself changed. ``--stat`` limits output to the summary.
