...
class PlatformRegistry:
    ...
    def __init__(self) -> None:
        ...
        # plugin-discovery time added several seconds to *every* `athena`
        # invocation -- including plain `athena chat`, which never touches any
        ...
        # `athena setup`/`gateway status`, send_message).
    ...
    def _resolve_all(self) -> None:
        ...
        gateway startup, ``athena setup``/``gateway status``, channel
