...
def test_connect_falls_back_to_delete_on_locking_protocol(tmp_path, monkeypatch, caplog):
    ...
    import athena_state as _athena_state
    monkeypatch.setattr(
        _athena_state, "is_sqlite_wal_reset_vulnerable",
        lambda version_info=None: False,
    )
    _athena_state._wal_fallback_warned_paths.clear()
...
def test_connect_works_when_wal_is_silently_refused(tmp_path, monkeypatch, caplog):
    ...
    monkeypatch.setattr(
        athena_state, "is_sqlite_wal_reset_vulnerable",
        lambda version_info=None: False,
    )
