...
class TestWebServerEndpoints:
    ...
    def test_update_athena_returns_docker_guidance_without_spawning(self, monkeypatch):
        ...
        assert "docker pull engsathiago/athena-agent:latest" in data["message"]
        ...
        assert any("docker pull engsathiago/athena-agent:latest" in line for line in status_data["lines"])
...
class TestBuildSchemaFromConfig:
    ...
    def test_timezone_field_is_searchable_select(self):
        ...
        """
        from athena_cli.web_server import CONFIG_SCHEMA, _timezone_options
