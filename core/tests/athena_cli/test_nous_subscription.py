...
def test_has_agent_browser_resolves_via_athena_managed_node_path(monkeypatch, tmp_path):
    """The managed-Node rung: a runnable agent-browser under the Athena Node
