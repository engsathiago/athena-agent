...
class TestWindowlessGatewayRestartSpec:
    ...
    def test_windows_keeps_console_python_and_preserves_tail(self):
        ...
        # ``from athena_cli.gateway import PROJECT_ROOT`` resolves from
        ...
        import athena_cli.config  # noqa: F401
        ...
        # Mock get_athena_home too: the real one calls Path.resolve(), which
