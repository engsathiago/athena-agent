...
def test_publish_marks_evidence_upload_failure_in_pr_comment(tmp_path, monkeypatch):
    ...
    assert updates == [
        (
            "https://api.github.com/repos/engsathiago/athena-agent/issues/comments/123",
            "github-token",
            "PATCH",
            {
